...
void rule_8(RULE_ARG_P);
void rule_9(RULE_ARG_P);
void rule_10(RULE_ARG_P);
void rule_11(RULE_ARG_P);
void rule_12(RULE_ARG_P);
void rule_13(RULE_ARG_P);
...
void rule_8(RULE_ARG(cont, x, y)){
    panel_container_insert(cont, x, y, 0x38, 0x00, 0);
}

void rule_9(RULE_ARG(cont, x, y)){
    panel_container_insert(cont, x, y, 0x39, 0x00, 0);
}

void rule_10(RULE_ARG(cont, x, y)){
    panel_container_insert(cont, x, y, 0x48, 0x00, 0);
}

void rule_11(RULE_ARG(cont, x, y)){
    panel_container_insert(cont, x, y, 0x49, 0x00, 0);
}

void rule_12(RULE_ARG(cont, x, y)){
    panel_container_insert(cont, x, y, 0x58, 0x00, 0);
}

void rule_13(RULE_ARG(cont, x, y)){
    panel_container_insert(cont, x, y, 0x59, 0x00, 0);
}
